...
import { PushTreeItem } from './pushTreeItem';
import { RepositorySelectionState } from './repositorySelectionState';

export type ChangedFilesTreeItem = ChangeGroupTreeItem | FileChangeTreeItem | CommitTreeItem | PushTreeItem;
